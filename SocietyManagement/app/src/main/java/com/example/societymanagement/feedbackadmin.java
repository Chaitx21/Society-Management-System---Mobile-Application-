    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                Toast.makeText(feedbackadmin.this, "Gender is: "+ radioButton.getText(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        buttonSubmitRating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(feedbackadmin.this, "Rating Value is "+ratingText, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(feedbackadmin.this,"True", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(feedbackadmin.this,"False", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
